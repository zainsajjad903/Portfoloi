...
import { Sun, Moon, Home, User, Code2, FolderGit2, Mail, Sparkles } from "lucide-react";
...
const Navbar = () => {
  ...
  const navigation = [
    { id: "hero-section", title: "Home", path: "#hero-section", icon: <Home size={19} /> },
    { id: "aboutme-section", title: "About", path: "#aboutme-section", icon: <User size={19} /> },
    { id: "skills-section", title: "Services", path: "#skills-section", icon: <Code2 size={19} /> },
    { id: "projects-section", title: "Projects", path: "#projects-section", icon: <FolderGit2 size={19} /> },
    { id: "contact-section", title: "Contact", path: "#contact-section", icon: <Mail size={19} /> },
  ];
    ...
    <>
      ...
      <header className="hidden md:block fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-6">
        ...
        >
          ...
          >
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 via-indigo-600 to-violet-600 text-white font-mono font-bold text-sm shadow-md shadow-indigo-500/20 group-hover:scale-105 transition-transform duration-300">
              <span>MZ</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              onClick={(e) => handleNavClick(e, "#contact-section", "contact-section")}
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-800/50 flex items-center justify-between shadow-sm">
        ...
        >
          <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-600 text-white font-mono font-bold text-xs shadow-sm">
            MZ
          </div>
          <div className="flex flex-col">
